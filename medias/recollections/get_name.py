...
# 指定文件夹路径和基础URL
folder_path = "F:/个人文件/博客/hexo/liwen1234/themes/itsneko/source/medias/recollections"  # 替换为您的图片文件夹路径
base_url = "https://minddiy.top//medias/recollections"  # 替换为您的基础URL
